...
<head>
  ...
  <title>Ted Llanes - MP2 | the source | blogs </title>
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item ms-3 dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="dropdown-item" href="../reviews/index.html"> reviews </a></li>

                  <li><a class="dropdown-item active" href="../blogs/index.html"> blogs </a></li>
