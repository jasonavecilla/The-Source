...
<head>
  ...
  <title>Ted Llanes - MP2 | the source | login </title>
...
<body>
  ...
  <section id="our-story" class="row container-fluid page-title mt-0">
  ...
  <section>
    ...
    <p class="text-center mt-4 mb-4"> don't have an account? <a href="../register/"> register here </a> </p>
            ...
            <div class="card text-black" style="border-radius: 25px;">
              <div class="card-body p-4 p-sm-5">
                <div class="row justify-content-center">
                  ...
                  <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-1" style="background-image: url('../assets/images/markus-spiske-sFydXGrt5OA-unsplash.jpg'); background-size: cover; background-position: center center; aspect-ratio: 16 / 9;">    
                  </div>

                  <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-2 pt-5 ps-lg-4 pb-4">
    
                    <form class="mx-3 mx-md-4">

                      <p class="text-center mb-4"><em>“To reap a return in ten years, plant trees. To reap a return in 100, cultivate the people.”</em> — Ho Chi Minh</p>
    
                      <div class="d-flex flex-row align-items-center mb-4">
                        <i class="fas fa-user fa-lg me-3 fa-fw"></i>
                        <div class="form-outline flex-fill mb-0">

                          <label class="form-label" for="custUser">username</label>
                          <input type="text" id="custUser" class="form-control" />
                      ...
                      <div class="d-flex flex-row align-items-center mb-4">
                        ...
                        <div class="form-outline flex-fill mb-0">
                          ...
                          <input type="password" id="custPass" class="form-control" />
                      ...
                      <div class="form-check d-flex justify-content-center mb-3">
                        <label class="form-check-label">
                          forgot your password? <a href="../get-new-password/">get new password</a>
                        </label>
                      </div>
                      <div class="my-3 text-center" id="lgnMsg"></div>
    
                      <div class="d-grid gap-0 mx-4 mb-3 mb-lg-4">
                        <button type="button" class="btn btn-primary btn-lg" id="btnCustLogin">log in</button>
                      </div>
