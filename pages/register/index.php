...
<head>
  ...
  <title>Ted Llanes - MP2 | the source | register </title>
...
<body>
  ...
  <section id="reg" class="row container-fluid page-title mt-0">
  ...
  <section>
    ...
    <p class="text-center mt-4 mb-4"> already have an account? <a href="../login/"> login here </a> </p>
            ...
            <div class="card text-black" style="border-radius: 25px;">
              <div class="card-body p-4 p-sm-5">
                <div class="row justify-content-center">
                  <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1 pt-5 pe-lg-4 pb-4">
    
                    <form class="mx-3 mx-md-4">

                      <p class="text-center mb-4"><em>“Remember, what you are planting in your life now, and your business, is going to grow up to become your tomorrow.”</em></p>
    
                      <div class="d-flex flex-row align-items-center mb-4">
                        <i class="fas fa-user fa-lg me-3 fa-fw"></i>
                        <div class="form-outline flex-fill mb-0">

                          <label class="form-label" for="custRegName">your name</label>
                          <input type="text" id="custRegName" class="form-control" />
                      ...
                      <div class="d-flex flex-row align-items-center mb-4">
                        ...
                        <div class="form-outline flex-fill mb-0">
                          ...
                          <label class="form-label" for="custRegEmail">your email</label>
                          <input type="email" id="custRegEmail" class="form-control" />
                          <span class="evm"></span>
                      ...
                      <div class="d-flex flex-row align-items-center mb-4">
                        ...
                        <div class="form-outline flex-fill mb-0">
                          ...
                          <label class="form-label" for="custRegUserN">username</label>
                          <input type="text" id="custRegUserN" class="form-control" />
                          <span class="uvm"></span>
                      ...
                      <div class="d-flex flex-row align-items-center mb-4">
                        ...
                        <div class="form-outline flex-fill mb-0">
                          ...
                          <input type="password" id="custRegPass" class="form-control" />
                      ...
                      <div class="d-flex flex-row align-items-center mb-4">
                        ...
                        <div class="form-outline flex-fill mb-0">
                          ...
                          <label class="form-label" for="custRegPassCon">repeat your password</label>
                          <input type="password" id="custRegPassCon" class="form-control" />
                          <span class="pvm"></span>
                      ...
                      <div class="form-check d-flex justify-content-center mb-2">
                        <input class="form-check-input me-2" type="checkbox" value="agree" id="custAgree" />
                        <label class="form-check-label" for="form2Example3">
                          I agree all statements in <a href="../terms-and-conditions/">terms and conditions</a>
                        </label>
                      </div>
                      <div class="tandc text-center w-100 mb-4"></div>
    
                      <div class="d-grid gap-0 mx-4 mb-3 mb-lg-4">
                        <button type="button" class="btn btn-primary btn-lg" id="btnCustReg">register</button>
                      </div>
    
                    </form>
    
                  </div>
                  <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2" style="background-image: url('../assets/images/greenforce-staffing-bYZn_C-RswQ-unsplash.jpg'); background-size: cover; background-position: center center; aspect-ratio: 16 / 9;">
