...
<head>
  ...
  <title>Ted Llanes - MP2 | the source | get new password </title>
...
<body>
  ...
  <section class="mb-5 p-3 p-sm-0">

    <div class="container col-md-4 col-lg-3 p-4 my-3 shadow rounded" style="background-color: #efefef;">
