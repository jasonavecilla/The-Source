...
if ($dbConn == true) {
    ...
    try {
        ...
        if ($eUpdate == true) {
            ...
            $mail->Subject = "User requested to change his/her password:"." ".$sUser;
            $mail->Body = nl2br("sending otp: ".$sOtp);			
            $mail->IsHTML(true);
            ...
            $mailtoUser->AddAddress($sEmail);
            
            $mailtoUser->Subject = "here is your OTP to change your password";
