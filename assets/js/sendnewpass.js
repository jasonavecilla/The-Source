    ...
    $.ajax({
        ...
        success: (result) => {
            ...
            if(result == 'You provided a wrong otp, please try again'){
                ...
                document.querySelector('.div-gnp').innerHTML = '<div><h4 class="text-secondary text-center">New password sent to your email! <a href="../login">Got to login page >></a></h4></div>'; 
            }
