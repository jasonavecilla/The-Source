...
if ($dbConn == true) {
    ...
    try {
        ...
        if ($eUpdate == true) {
            ...
            $mail->Subject = "User request new password:"." ".$vEmail;
            ...
            $mailtoUser->Body = nl2br("otp: ".$sOtp."
                                Please follow the link here <a href='https://llanes.wd49p.com/02-mp/forgot-password/otp.php?id=".$nId."'>get new pass</a> and provide your otp <b>".$sOtp."</b> to proceed.");
